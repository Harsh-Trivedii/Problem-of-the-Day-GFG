Problem of the day: Water the plants

Question link: https://www.geeksforgeeks.org/problems/water-the-plants--170646/1

Question: A gallery with plants is divided into n parts, numbered 0, 1, 2, 3, ..., n-1. There are provisions for attaching water sprinklers in every division. A sprinkler with range x at division i can water all divisions from i-x to i+x.
