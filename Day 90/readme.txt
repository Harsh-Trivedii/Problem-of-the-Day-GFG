Problem of the day: Shuffle integers

Question link: https://www.geeksforgeeks.org/problems/shuffle-integers2401/1

Question: Given an array arr of n elements in the following format {a1, a2, a3, a4, ... , an/2, b1, b2, b3, b4, ... , bn/2}, the task is shuffle the array to {a1, b1, a2, b2, a3, b3, ... , an/2, bn/2} without using extra space.
Note that n is even.
