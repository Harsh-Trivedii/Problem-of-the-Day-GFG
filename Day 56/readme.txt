Problem of the day: Number of paths

Question link: https://practice.geeksforgeeks.org/problems/number-of-paths0926/1

Question: The problem is to count all the possible paths from top left to bottom right of an MxN matrix with the constraints that from each cell you can either move to right or down.
