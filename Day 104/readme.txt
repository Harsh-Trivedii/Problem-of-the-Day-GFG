Problem of the day: Smith Number

Question link: https://www.geeksforgeeks.org/problems/smith-number4132/1

Question: Given a number n, the task is to find out whether this number is a Smith number or not. A Smith number is a composite number whose sum of digits is equal to the sum of digits of its prime factors.
