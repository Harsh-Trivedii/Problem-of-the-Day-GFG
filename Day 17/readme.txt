Problem of the day: Largest number possible

Question link: https://practice.geeksforgeeks.org/problems/largest-number-possible5028/1

Question: Given two numbers 'N' and 'S' , find the largest number that can be formed with 'N' digits and whose sum of digits should be equals to 'S'. Return -1 if it is not possible.
