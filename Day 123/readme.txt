Problem of the day: Wildcard string matching

Question link: https://www.geeksforgeeks.org/problems/wildcard-string-matching1126/1

Question: Given two strings wild and pattern. Determine if the given two strings can be matched given that, wild string may contain * and ? but string pattern will not. * and ? can be converted to another character according to the following rules:
