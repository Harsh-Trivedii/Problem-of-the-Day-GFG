Problem of the day: Find the String

Question link: https://www.geeksforgeeks.org/problems/find-the-string/1

Question: Given two integers N and K, the task is to find the string S of minimum length such that it contains all possible strings of size N as a substring. The characters of the string should be from integers ranging from 0 to K-1.  
