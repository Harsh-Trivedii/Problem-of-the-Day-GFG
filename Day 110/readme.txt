Problem of the day: Reach the Nth point

Question link: https://www.geeksforgeeks.org/problems/reach-the-nth-point5433/1

Question: There are N points on the road, you can step ahead by 1 or 2 . If you start from a point 0, and can only move from point i to point i+1 after taking a step of length one, find the number of ways you can reach at point N. 
