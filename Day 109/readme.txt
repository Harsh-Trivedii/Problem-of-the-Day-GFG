Problem of the day: Painting the Fence

Question link: https://www.geeksforgeeks.org/problems/painting-the-fence3727/1

Question: Given a fence with n posts and k colors, find out the number of ways of painting the fence so that not more than two consecutive posts have the same colors. Since the answer can be large return it modulo 109 + 7.
