Problem of the day: Remove K Digits

Question link: https://www.geeksforgeeks.org/problems/remove-k-digits/1

Question: Given a non-negative integer S represented as a string, remove K digits from the number so that the new number is the smallest possible.
