Problem of the day: Game of XOR

Question link: https://www.geeksforgeeks.org/problems/game-of-xor1541/1

Question: Given an array A of size N. The value of an array is denoted by the bit-wise XOR of all elements it contains. Find the bit-wise XOR of the values of all subarrays of A.
