Problem of the day: AVL Tree Insertion

Question link: https://www.geeksforgeeks.org/problems/avl-tree-insertion/1

Question: Given an AVL tree and N values to be inserted in the tree. Write a function to insert elements into the given AVL tree.
