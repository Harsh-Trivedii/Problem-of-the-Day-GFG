Problem of the day: Max Sum without Adjacents

Question link: https://www.geeksforgeeks.org/problems/max-sum-without-adjacents2430/1

Question: Given an array Arr of size N containing positive integers. Find the maximum sum of a any possible subsequence such that no two numbers in the subsequence should be adjacent in Arr.
