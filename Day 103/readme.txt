Problem of the day: Transform to prime

Question link: https://www.geeksforgeeks.org/problems/transform-to-prime4635/1

Question: Given an array of n integers. Find the minimum positive number to be inserted in array, so that sum of all elements of array becomes prime.
