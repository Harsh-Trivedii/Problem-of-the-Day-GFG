Problem of the day: Split Array Largest Sum

Question link: https://www.geeksforgeeks.org/problems/split-array-largest-sum--141634/1

Question: Given an array arr[] of N elements and a number K., split the given array into K subarrays such that the maximum subarray sum achievable out of K subarrays formed is minimum possible. Find that possible subarray sum.
