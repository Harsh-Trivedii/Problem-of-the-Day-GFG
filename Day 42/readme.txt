Problem of the day: Insert in a Sorted List

Question link: https://practice.geeksforgeeks.org/problems/insert-in-a-sorted-list/1

Question: Given a linked list sorted in ascending order and an integer called data, insert data in the linked list such that the list remains sorted.
