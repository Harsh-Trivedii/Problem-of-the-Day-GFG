Problem of the day: Find Transition Point

Question link: https://www.geeksforgeeks.org/problems/find-transition-point-1587115620/1

Question: Given a sorted array containing only 0s and 1s, find the transition point, i.e., the first index where 1 was observed, and before that, only 0 was observed.
