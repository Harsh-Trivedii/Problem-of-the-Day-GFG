Problem of the day: Insertion Sort for Singly Linked List

Question link: https://www.geeksforgeeks.org/problems/insertion-sort-for-singly-linked-list/1

Question: Given a singly linked list, sort the list (in ascending order) using insertion sort algorithm.
