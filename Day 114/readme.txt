Problem of the day: Rightmost different bit

Question link: https://www.geeksforgeeks.org/problems/rightmost-different-bit-1587115621/1

Question: Given two numbers M and N. The task is to find the position of the rightmost different bit in the binary representation of numbers. If both M and N are the same then return -1 in this case.
