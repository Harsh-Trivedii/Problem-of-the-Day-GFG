Problem of the day: Anti Diagonal Traversal of Matrix

Question link: https://www.geeksforgeeks.org/problems/print-diagonally1623/1

Question: Give a N*N square matrix, return an array of its anti-diagonals in top-leftmost to bottom-rightmost order. In an element of a anti-diagonal (i, j), surrounding elements will be (i+1, j-1) and (i-1, j+1). Look at the examples for more clarity.
